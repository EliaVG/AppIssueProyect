...
class AppService {
  ...
  getApp(id) {
    return axios.get(`${API_URL}/apps?filters[id][$eq]=${id}&populate=deep`);
  }
  ...
  getDevices() {
    return axios.get(
      `${API_URL}/devices?fields=fxmId,id,code,portalIds,appCodeManager&populate=countries&pagination[limit]=200`
    );
  }
